...
public class ServicoClientePFTest {
    ...
    void atualizar_quandoClientePFExiste_entaoRetornoValido() {
        ...
        final ClientePF clientePFAtualizado = new ClientePF(
                UtilitariosGerais.formatarCpf(atualizacaoClientePFDTO.cpf()), atualizacaoClientePFDTO.mcc(),
        ...
        final RespostaAtualizacaoClientePFDTO respostaAtualizacaoClientePFDTO = new RespostaAtualizacaoClientePFDTO(
                clientePFAtualizado.getId(), clientePFAtualizado.getCpf(), clientePFAtualizado.getNome(),
                clientePFAtualizado.getMcc(), clientePFAtualizado.getEmail(), clientePFAtualizado.getCriadoEm(),
    ...
    void atualizar_quandoDadosRepetidos_entaoRetornaErro() {
        ...
        final AtualizacaoClientePFDTO atualizacaoClientePFDTO = new AtualizacaoClientePFDTO(clientePFExistente.getMcc(),
                UtilitariosGerais.removerFormatacaoCpfCnpj(clientePFExistente.getCpf()), clientePFExistente.getNome(),
    ...
    void criar_quandoPrimeiroCadastro_entaoRetornoValido() {
        ...
        final ClientePF clientePFCriado = new ClientePF(UtilitariosGerais.formatarCpf(criacaoClientePFDTO.cpf()),
        ...
        final RespostaCriacaoClientePFDTO respostaCriacaoClientePFDTO = new RespostaCriacaoClientePFDTO(
                clientePFCriado.getId(), clientePFCriado.getCpf(), clientePFCriado.getNome(), clientePFCriado.getMcc(),
